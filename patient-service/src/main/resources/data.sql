...
--When the application starts, Spring Boot automatically detects the data.sql file and executes the SQL statements within it, inserting the specified data into the H2 in-memory database. This process is facilitated by the Spring Boot auto-configuration and the properties defined in application.properties.